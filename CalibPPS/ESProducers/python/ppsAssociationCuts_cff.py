...
p2016 = cms.PSet(
    ...
    association_cuts_45=cms.PSet(
        ...
        xi_cut_treshold=cms.string("0.010"),
    ...
    association_cuts_56=cms.PSet(
        xi_cut_mean= cms.string("0."),
        xi_cut_treshold=cms.string("0.015"),
...
p2017 = cms.PSet(
    ...
    association_cuts_45=cms.PSet(
        ...
        xi_cut_treshold=cms.string("5. * 0.00121"),
        ti_tr_min=cms.double(-1.5),
        ti_tr_max=cms.double(2.0)
    ),
    association_cuts_56=cms.PSet(
        y_cut_mean=cms.string("-0.022612"),
        y_cut_treshold=cms.string("5. * 0.14777"),
        xi_cut_mean=cms.string("+8.012857e-5"),
        xi_cut_treshold=cms.string("5. * 0.0020627"),
        ti_tr_min=cms.double(-1.5),
        ti_tr_max=cms.double(2.0)
    ),
)
...
p2018 = cms.PSet(
    ...
    association_cuts_45=cms.PSet(
        ...
        x_cut_treshold=cms.string("4. * 0.16008188"),
        y_cut_mean=cms.string("+0.10973631"),
        y_cut_treshold=cms.string("4. * 0.1407986"),
        xi_cut_mean=cms.string("+3.113062e-5"),
        xi_cut_treshold=cms.string("4. * 0.0012403586"),
        ti_tr_min=cms.double(-1.5),
        ti_tr_max=cms.double(2.0)
    ),
    association_cuts_56=cms.PSet(
        x_cut_mean=cms.string("+0.073016431"),
        x_cut_treshold=cms.string("5. * 0.18126434"),
        y_cut_mean=cms.string("+0.064261029"),
        y_cut_treshold=cms.string("5. * 0.14990802"),
        xi_cut_mean=cms.string("-1.1852528e-5"),
        xi_cut_treshold=cms.string("5. * 0.002046409"),
        ti_tr_min=cms.double(-1.5),
        ti_tr_max=cms.double(2.0)
    ),
)
